...
@section('content')
    <h1 class="text-gray-500 hover:text-gray-800 cursor-pointer mb-6">Dashboard</h1>
        ...
        <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            <div class="relative overflow-hidden rounded-lg bg-white px-4 pb-12 pt-5 shadow sm:px-6 sm:pt-6">
                <dt>
                    ...
                    <p class="ml-16 truncate text-sm font-medium text-gray-500">Total Product</p>
                </dt>
                <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
                    <p class="text-2xl font-semibold text-gray-900">{{$product}}</p>
